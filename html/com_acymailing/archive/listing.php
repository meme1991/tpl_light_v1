...
<section class="wrapper">
	<div id="acyarchivelisting" class="container">
	<?php if(ACYMAILING_J16){ JHtml::_('script', 'system/core.js', false, true); }?>
	<?php if($this->values->show_page_heading): ?>
		<h1 class="page_heading <?php echo $this->values->suffix; ?>"><?php echo $this->values->page_heading; ?></h1>
	<?php endif; ?>
	<form action="<?php echo acymailing_completeLink('archive&listid='.$this->list->listid); ?>" method="post" name="adminForm" id="adminForm" >
		...
		<?php endif; ?>
			<tr>
				<td>
					<?php if(!empty($this->manageableLists)) : ?>
						<p class="acynewbutton">
							<a class="btn btn-primary" href="<?php echo acymailing_completeLink('frontnewsletter&task=add&listid='.$this->list->listid); ?>" title="<?php echo JText::_('CREATE_NEWSLETTER',true); ?>" >
								<img class="icon16" src="<?php echo ACYMAILING_IMAGES; ?>icons/icon-16-add.png" alt="<?php echo JText::_('CREATE_NEWSLETTER',true); ?>" /> <?php echo JText::_('CREATE_NEWSLETTER'); ?>
							</a>
						</p>
					<?php endif; ?>
		...
		<?php if(!empty($this->manageableLists)) : ?>
			<p class="acynewbutton">
				<a class="btn" href="<?php echo acymailing_completeLink('frontnewsletter&task=add&listid='.$this->list->listid); ?>" title="<?php echo JText::_('CREATE_NEWSLETTER',true); ?>" >
					<img class="icon16" src="<?php echo ACYMAILING_IMAGES; ?>icons/icon-16-add.png" alt="<?php echo JText::_('CREATE_NEWSLETTER',true); ?>" /> <?php echo JText::_('CREATE_NEWSLETTER'); ?>
				</a>
			</p>
		<?php endif; ?>
