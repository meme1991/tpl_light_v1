...
<?php if($this->values->filter) : ?>
	<div class="form-group row">
		<div class="col-12 col-sm-12 col-md-12 col-lg-4">
			<input placeholder="<?php echo JText::_('ACY_SEARCH'); ?>" type="text" name="search" id="acymailingsearch" value="<?php echo $this->escape($this->pageInfo->search); ?>" class="form-control"/>
		</div>
		<div class="col-12 col-sm-6 col-md-4 col-lg-2 mt-md-2 mt-lg-0">
			<button class="btn btn-primary btn-block buttongo" onclick="this.form.submit();"><?php echo JText::_('JOOMEXT_GO'); ?></button>
		</div>
		<div class="col-12 col-sm-6 col-md-4 col-lg-2 mt-md-2 mt-lg-0">
			<button class="btn btn-info btn-block buttonreset" onclick="document.getElementById('acymailingsearch').value='';this.form.submit();"><?php echo JText::_('JOOMEXT_RESET'); ?></button>
		</div>
		<div class="col-12 col-sm-12 col-md-4 col-lg-4 mt-md-2 mt-lg-0">
