...
?>
<div id="acyarchiveview" class="wrapper">
	<div class="container">
		<div><?php if($this->config->get('frontend_subject',1)){ ?>
			<h1 class="page-heading contentheading<?php echo $this->values->suffix; ?>">
				<?php echo $this->mail->subject; ?>
