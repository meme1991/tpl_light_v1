...
?>
<div id="eb-category-page-table" class="wrapper container eb-container">
	<?php
    ...
    ');
	?>
	<form method="post" name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_eventbooking&view=category&layout=table&id='.$this->categoryId.'&Itemid='.$this->Itemid); ?>">
