...
<?php
	...
	<div class="form-actions d-flex justify-content-between">
		<input type="button" class="btn btn-secondary" name="btn-group-billing-back" id="btn-group-billing-back" value="<?php echo  JText::_('EB_BACK') ;?>">
		...
		var eb_current_page = 'group_billing';
			Eb.jQuery(document).ready(function($){
				...
				$('#btn-group-billing-back').click(function(){
					$.ajax({
						url: siteUrl + 'index.php?option=com_eventbooking&task=register.store_billing_data_and_display_group_members_form&event_id=<?php echo $this->event->id; ?>&Itemid=<?php echo $this->Itemid; ?>&format=raw' + langLinkForAjax,
						type: 'post',
