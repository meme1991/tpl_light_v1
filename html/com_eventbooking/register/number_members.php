...
JFactory::getDocument()->addScriptOptions('eventId', $this->event->id)
	->addScriptOptions('Itemid', $this->Itemid)
    ->addScriptOptions('collectMemberInformation', $this->collectMemberInformation)
	->addScript(JUri::root(true) . '/media/com_eventbooking/js/site-register-group.min.js');
...
<form name="eb-form-number-group-members" id="eb-form-number-group-members" autocomplete="off" class="<?php echo $formHorizontalClass; ?>">
	...
	<div class="form-actions d-flex justify-content-between">
		<input type="button" name="btn-number-members-back" id="btn-number-members-back" class="btn btn-secondary" value="<?php echo JText::_('EB_BACK'); ?>" onclick="window.history.go(-1) ;" />
