	                                    ...
	                                    <div class="eb-taskbar">
	                                        <ul>
							                    ...
							                    if ($registrationUrl)
							                    {
								                 ?>
	                                                <li>
	                                                    <a class="<?php echo $btnPrimary . ' eb-register-button eb-external-registration-link'; ?>" href="<?php echo $registrationUrl; ?>" target="_blank"><?php echo JText::_('EB_REGISTER');; ?></a>
	                                                </li>
								                 <?php
							                    }
...
if ($showAddEventsButton)
{
    EventbookingHelperHtml::renderaddEventsToCartHiddenForm();
}
