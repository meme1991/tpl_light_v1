...
if (count($this->items)) 
{
	...
	?>
	<div class="eshop-categories-list"><?php echo EshopHtmlHelper::loadCommonLayout('common/categories_products.php', array ('categories' => $this->items, 'tax' => $this->tax, 'currency' => $this->currency, 'bootstrapHelper' => $this->bootstrapHelper)); ?></div>
	<?php
