...
{
    ?>
    <div id="shipping-new" class="form-horizontal">
        <?php
        echo $this->form->render();
        ?>
    </div>
...
<div class="no_margin_left">
	<input type="button" class="btn btn-primary <?php echo $pullRightClass; ?>" id="button-shipping-address" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
