...
else
{
	...
	?>
	<form id="adminForm" class="eshop-order-view">
	...
	<div class="no_margin_left">
		<input type="button" value="<?php echo JText::_('ESHOP_BACK'); ?>" id="button-user-orderinfor" class="btn btn-outline-primary <?php echo $pullRightClass; ?>">
	</div>
	<?php
}
?>
