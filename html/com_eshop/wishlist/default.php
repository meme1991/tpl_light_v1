				...
				foreach ($this->products as $product)
				{
					...
					<tr>
						...
						<td data-content="<?php echo JText::_('ESHOP_ACTION'); ?>">
							...
							?>
							<input type="button" class="btn btn-danger" onclick="removeFromWishlist(<?php echo $product->id; ?>, '<?php echo EshopHelper::getSiteUrl(); ?>', '<?php echo EshopHelper::getAttachedLangLink(); ?>');" value="<?php echo JText::_('ESHOP_REMOVE'); ?>" />
						</td>
					</tr>
					<?php
				}
