		...
		<div class="col-12 col-sm-8 col-md-6">
			...
			<form id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate form-horizontal well" enctype="multipart/form-data">
				...
				<div class="control-group mt-4">
					<div class="controls">
						<button type="submit" class="btn btn-primary btn-block validate">
							<i class="fas fa-check-circle"></i> <?php echo JText::_('JREGISTER'); ?>
						</button>
						<a class="btn btn-secondary btn-block" href="<?php echo JRoute::_(''); ?>" title="<?php echo JText::_('JCANCEL'); ?>">
