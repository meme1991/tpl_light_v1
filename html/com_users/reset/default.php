	...
	<div class="container com_users remind<?php echo $this->pageclass_sfx; ?>">
		<div class="row justify-content-center">
			<div class="col-12 col-md-6">
				...
				<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=reset.request'); ?>" method="post" class="form-validate form-horizontal well mt-3">
					...
					<div class="control-group mt-2">
						<div class="controls">
							<button type="submit" class="btn btn-primary btn-block validate"><i class="fas fa-paper-plane pr-2"></i> <?php echo JText::_('JSUBMIT'); ?></button>
						</div>
					</div>
