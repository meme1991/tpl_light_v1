...
<?php defined('_JEXEC') or die('Restricted access'); ?>
	<div class="eshop_mod_search default-layout eshop-search<?php echo $params->get( 'moduleclass_sfx' ) ?>">
      ...
      <input class="form-control inputbox product_search" type="text" name="keyword" id="prependedInput" value="" placeholder="<?php echo JText::_('Ricerca un comune...'); ;?>">
    </div>
	...
	<?php //var_dump(JRoute::_(EshopRoute::getCategoryRoute(2)));  ?>
	...
	$(document).ready(function(){
		...
		function search() {
			...
			if(query_value !== ''){
				...
				$.ajax({
					type: "POST",
					// url: "http://localhost/joomla/templates/light/libreries/test.php",
					url: "<?= JURI::base() ?>templates/light/libreries/eshopCategoriesSearch.php",
